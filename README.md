# Declarations of terms tracked in the *test4* collection
...
You can [explore the tracked versions](https://github.com/Ndpnt/test4-versions) interactively or [download them as a dataset](https://github.com/Ndpnt/test4-versions/releases) in the `Ndpnt/test4-versions` repository.
